function [ extractResult ] = ISSextractAfterScale( wmFolderPath, attackedFolderPath )
%ISSEXTRACTAFTERSCALE Summary of this function goes here
%   This will extract watermark for all images in the given folder.
%   Execute exmaple:
%       extractResult = ISSextractAfterScale('/Users/blue/Documents/MATLAB/104_1/MMSEC/HW1/experiment/watermarked_image/wm/airplane/', '/Users/blue/Documents/MATLAB/104_1/MMSEC/HW1/experiment/attacked_image/4_scale/airplane/')
...
for idx = 1:totalNumOfWMFile
	...
	if(height > STD_HEIGHT && width > STD_WIDTH)
		...
		attackedImage = scaledImage(topMargin+1:topMargin+STD_HEIGHT, leftMargin+1:leftMargin+STD_WIDTH, :);
	end
	imwrite(attackedImage, [attackedFolderPath wmImageName(1:end-4) '_scale.png']);
end
