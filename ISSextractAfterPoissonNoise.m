function [ extractResult ] = ISSextractAfterPoissonNoise( wmFolderPath, attackedFolderPath )
%ISSEXTRACTAFTERPOISSONNOISE Summary of this function goes here
%   This will extract watermark for all images in the given folder.
%   Execute exmaple:
%       extractResult = ISSextractAfterPoissonNoise('/Users/blue/Documents/MATLAB/104_1/MMSEC/HW1/experiment/watermarked_image/wm/airplane/', '/Users/blue/Documents/MATLAB/104_1/MMSEC/HW1/experiment/attacked_image/8_poissonnoise/airplane/')
...
for idx = 1:totalNumOfWMFile
	...
	%% Poisson Noise
	poissonNoiseImage = imnoise(wmImage, 'poisson');
	attackedImage = poissonNoiseImage;

	imwrite(attackedImage, [attackedFolderPath wmImageName(1:end-4) '_pnoise.png']);
end
