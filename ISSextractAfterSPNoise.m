function [ extractResult ] = ISSextractAfterSPNoise( wmFolderPath, attackedFolderPath )
%ISSEXTRACTAFTERSPNOISE Summary of this function goes here
%   This will extract watermark for all images in the given folder.
%   Execute exmaple:
%       extractResult = ISSextractAfterSPNoise('/Users/blue/Documents/MATLAB/104_1/MMSEC/HW1/experiment/watermarked_image/wm/airplane/', '/Users/blue/Documents/MATLAB/104_1/MMSEC/HW1/experiment/attacked_image/9_spnoise/airplane/')
...
for idx = 1:totalNumOfWMFile
	...
	%% Salt & Pepper Noise
	spNoiseImage = imnoise(wmImage, 'salt & pepper', 0.001);
	attackedImage = spNoiseImage;

	imwrite(attackedImage, [attackedFolderPath wmImageName(1:end-4) '_spnoise.png']);
end
