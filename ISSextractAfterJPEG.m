function [ extractResult ] = ISSextractAfterJPEG( wmFolderPath, attackedFolderPath )
%ISSEXTRACTAFTERJPEG Summary of this function goes here
%   This will extract watermark for all images in the given folder.
%   Execute exmaple:
%       extractResult = ISSextractAfterJPEG('/Users/blue/Documents/MATLAB/104_1/MMSEC/HW1/experiment/watermarked_image/wm/airplane/', '/Users/blue/Documents/MATLAB/104_1/MMSEC/HW1/experiment/attacked_image/1_jpeg/airplane/')
...
for idx = 1:totalNumOfWMFile
	...
	%% JPEG
	imwrite(wmImage, [attackedFolderPath wmImageName(1:end-4) '_jpeg.jpg']);
end
