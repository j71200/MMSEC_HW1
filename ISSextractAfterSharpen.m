function [ extractResult ] = ISSextractAfterSharpen( wmFolderPath, attackedFolderPath )
%ISSEXTRACTAFTERSHARPEN Summary of this function goes here
%   This will extract watermark for all images in the given folder.
%   Execute exmaple:
%       extractResult = ISSextractAfterSharpen('/Users/blue/Documents/MATLAB/104_1/MMSEC/HW1/experiment/watermarked_image/wm/airplane/', '/Users/blue/Documents/MATLAB/104_1/MMSEC/HW1/experiment/attacked_image/7_sharpen/airplane/')
...
for idx = 1:totalNumOfWMFile
	...
	%% Sharpen
	sharpenedImage = imsharpen(wmImage);
	attackedImage = sharpenedImage;

	imwrite(attackedImage, [attackedFolderPath wmImageName(1:end-4) '_sharpen.png']);
end
